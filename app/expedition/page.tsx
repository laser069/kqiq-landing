    ...
    <div className="flex flex-col w-full bg-[#f8fafc] text-slate-900 selection:bg-sky-500/10 font-oswald">
      ...
      <section className="relative h-screen w-full flex items-center px-4 sm:px-12 md:px-24 overflow-hidden bg-[#e0e5ec]">
        ...
        <div className="relative z-10 max-w-4xl space-y-12">
          ...
          <div className="relative p-1 bg-[#e0e5ec] rounded-[1.5rem] md:rounded-[2rem] shadow-[10px_10px_20px_#bebebe,-10px_-10px_20px_#ffffff] max-w-2xl">
            <p className="p-4 sm:p-8 text-slate-600 text-base sm:text-lg md:text-xl leading-relaxed tracking-tight font-medium italic">
