...
export default function Page(): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#e0e5ec] text-slate-900 selection:bg-sky-500/20 font-oswald overflow-x-hidden">
      ...
      {/* ------------------------------------------------------------ */}
      {/* 2. 3D CAROUSEL TRACK (LOCKS SCROLL)                           */}
      {/* ------------------------------------------------------------ */}
      <section className="relative bg-[#e0e5ec]">
        <div className="container mx-auto px-4 pt-12 relative z-20" />
        <ThreeDPhotoCarouselDemo />
      </section>

      {/* ------------------------------------------------------------ */}
      {/* 3. SCROLL GATE (CRITICAL)                                     */}
      {/* This absorbs scroll so GatewayScroll cannot pin early        */}
      {/* ------------------------------------------------------------ */}
      {/* ------------------------------------------------------------ */}
      {/* 4. GATEWAY SCROLL (STARTS ONLY AFTER CAROUSEL FINISHES)       */}
      {/* ------------------------------------------------------------ */}
      <GatewayScroll />
