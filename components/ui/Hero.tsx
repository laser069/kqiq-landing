...
export default function Hero({
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-[#e0e5ec] flex items-center">
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-24 md:py-24 h-full flex flex-col justify-center gap-8 md:gap-10 lg:gap-16">
