...
export default function Hero({
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-[#e0e5ec] flex items-center">
      ...
      <div className="relative z-20 container mx-auto px-6 md:px-12 lg:px-20 py-32 md:py-24 h-full flex flex-col justify-center gap-10 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <span className="text-xs sm:text-sm md:text-xl font-oswald font-bold tracking-[0.2em] md:tracking-[0.4em] text-slate-400 uppercase">
              BY {brandName}
            </span>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          >
            <p className="text-xl sm:text-2xl md:text-3xl text-slate-950 font-black leading-[1.2] md:leading-[1.1] uppercase tracking-tight">
              {subtitleLine1}
            </p>
            <p className="text-sm sm:text-base md:text-lg text-slate-600 font-medium leading-relaxed max-w-lg">
              {subtitleLine2}
            </p>
          </motion.div>
          ...
          {primaryCtaText && (
            <motion.div
              ...
              className="lg:col-span-5 flex flex-col justify-start items-start lg:items-end mt-4 sm:mt-8 lg:mt-16"
            >
              <button 
                onClick={onPrimaryClick}
                className="w-full sm:w-auto bg-slate-950 text-white px-10 py-5 rounded-none font-oswald font-bold text-base sm:text-lg uppercase tracking-[0.2em] transition-all duration-300 hover:bg-slate-800 hover:-translate-y-1 active:scale-95"
              >
                {primaryCtaText}
              </button>
            </motion.div>
